...
CREATE TABLE `Partido` (
  ...
  `updatedAt` DATETIME(3) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(3),
...
ALTER TABLE
  `Partido`
ADD
  CONSTRAINT `Partido_idDeputado_fkey` FOREIGN KEY (`idDeputado`) REFERENCES `Deputado`(`id`) ON DELETE
SET
...
ALTER TABLE
  `Legislatura`
ADD
  CONSTRAINT `Legislatura_idDeputado_fkey` FOREIGN KEY (`idDeputado`) REFERENCES `Deputado`(`id`) ON DELETE
SET
  NULL ON UPDATE CASCADE;
...
ALTER TABLE
  `RedeSocial`
ADD
  CONSTRAINT `RedeSocial_idDeputado_fkey` FOREIGN KEY (`idDeputado`) REFERENCES `Deputado`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE
  `Despesa`
ADD
  CONSTRAINT `Despesa_idFornecedor_fkey` FOREIGN KEY (`idFornecedor`) REFERENCES `Fornecedor`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE
  `Despesa`
ADD
  CONSTRAINT `Despesa_idTipoDespesa_fkey` FOREIGN KEY (`idTipoDespesa`) REFERENCES `TipoDespesa`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE
  `Despesa`
ADD
  CONSTRAINT `Despesa_idDeputadoId_fkey` FOREIGN KEY (`idDeputadoId`) REFERENCES `Deputado`(`id`) ON DELETE
SET
  NULL ON UPDATE CASCADE;